...
a = 3.13
PV = UEFC_wing.UEFC_wing(b=1.944, croot=0.294, ctip=0.118, agroot=a, agtip=-2.0+a, dihedral=10)

# Plot the wing geometry
PV.plotgeom()

# Solve the flow around the wing at a desired CL
G, alpha = PV.solve(CL=0.758) # The solution is returned in G and the required angle of attack in alpha
